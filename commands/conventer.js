...
function webp2mp4File(path) {
    ...
    AouraQueen['IntroduceCMD']({pattern: 'mp3$', fromMe: WorkType, desc: DATA.MP4TOAUDİO_DESC}, (async (message, input) => {
    ...
    AouraQueen['IntroduceCMD']({pattern: 'photo$', fromMe: WorkType, desc: DATA.STİCKER_DESC}, (async (message, input) => {
        const mid = message.jid
    ...
    AouraQueen['IntroduceCMD']({pattern: 'vsticker$', desc: DATA.ANİM_STİCK, fromMe: WorkType}, (async (message, input) => {
        const mid = message.jid
