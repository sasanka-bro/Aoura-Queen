...
AouraQueen['IntroduceCMD']({on: 'text', fromMe: false, dontAdCommandList: true, delownsewcmd: false}, (async (message, input) => {
...
AouraQueen['IntroduceCMD']({ pattern: 'tellbot$', desc: 'Toke With Artificial Intelligence Bot',dontAdCommandList: true, fromMe: false }, (async (message, input) => {
