...
AouraQueen['IntroduceCMD']({pattern: 'joke ?(.*)', fromMe: WorkType, desc: DATA.JOKE_DESC}, async (message, input) => {
...
AouraQueen['IntroduceCMD']({pattern: 'quote ?(.*)', fromMe: WorkType, desc: QUOTE_DESC}, async (message, input) => {
