...
AouraQueen['IntroduceCMD']({pattern: 'restart$', fromMe: true, desc: DATA.RESTART_DESC}, (async (message, input) => {
...
AouraQueen['IntroduceCMD']({pattern: 'shutdown$', fromMe: true, desc: DATA.SHUTDOWN_DESC}, (async(message, input) => {
    ...
    AouraQueen['IntroduceCMD']({pattern: 'dyno$', fromMe: true, desc: DATA.DYNO_DESC}, (async (message, input) => {
...
AouraQueen['IntroduceCMD']({pattern: 'setvar ?(.*)', fromMe: true, desc: DATA.SETVAR_DESC}, (async(message, input) => {
...
AouraQueen['IntroduceCMD']({pattern: 'var ?(.*)', fromMe: true, desc: DATA.SETVAR_DESC}, (async(message, input) => {
...
AouraQueen['IntroduceCMD']({pattern: 'delvar ?(.*)', fromMe: true, desc: DATA.DELVAR_DESC}, (async (message, input) => {
...
AouraQueen['IntroduceCMD']({pattern: 'getvar ?(.*)', fromMe: true, desc: DATA.GETVAR_DESC}, (async (message, input) => {
...
AouraQueen['IntroduceCMD']({pattern: 'conimg ?(.*)', fromMe: true, dontAdCommandList: true}, (async(message, input) => {
    if (input[1] === '') return
if (input[1].includes('/-/')) {
