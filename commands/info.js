...
if (Details.LANG == 'SI') ADMİN_USER = '✪\n✨➢ *පරිපාලකවරුන්:* ', USER_USER = '✨➢ *මුළු සාමාජීකයින්:* ', TR_USER = '✨➢ *තුර්කි අංක:* ', Hİ_USER = '✨➢ *ඉන්දියානු අංක:* ', AZ_USER = '✨➢ *Az අංක:* ', SRİ_USER = '✨➢ *ශ්‍රී ලාංකික අංක:* ', RU_USER = '✨➢ *රුසියානු අංක:* ', USA_USER = '✨➢ *USA අංක :* ', OTHER = '✨➢ *වෙනත් අංක:* '
    ...
    AouraQueen['IntroduceCMD']({ pattern: 'info$', fromMe: WorkType, desc: SSSA.PL_DESC, dontAddCMDList: true }, async (message, input) => {
    ...
    AouraQueen['IntroduceCMD']({pattern: 'jid ?(.*)', fromMe: WorkType, desc: DATA.JID_DESC, dontAddCMDList: true}, (async (message, input) => {
...
let NEED_UWONG = "*Give me a user!*"
    AouraQueen['IntroduceCMD']({pattern: 'wame ?(.*)', fromMe: WorkType, desc: WAME_DESC}, (async (message, input) => {
        if (message.reply_message !== false) {
