...
AouraQueen['IntroduceCMD']({ pattern: 'scan ?(.*)', fromMe: WorkType, desc: DATA.SCAN}, (async (message, input) => {
...
AouraQueen['IntroduceCMD']({pattern: 'tag ?(.*)', fromMe: true, desc: DATA.TAGALL_DESC }, (async (message, input) => {
...
AouraQueen['IntroduceCMD']({pattern: 'tag ?(.*)', fromMe: false, desc: DATA.TAGALL_DESC }, (async (message, input) => {
