...
AouraQueen['IntroduceCMD']({pattern: 'print ?(.*)', fromMe: true, desc: dd}, (async (message, input) => {
...
AouraQueen['IntroduceCMD']({pattern: 'bashmedia ?(.*)', fromMe: wk_q, desc: bdesc, usage: 'video.mp4 && media/gif/pic.mp4'}, (async (message, input) => {
    var id = message.jid
    try {
...
AouraQueen['IntroduceCMD']({pattern: 'addserver$', fromMe: wk_ad, desc: addsdesc}, (async (message, input) => {
...
AouraQueen['IntroduceCMD']({on: 'text', fromMe: false, delownsewcmd: false}, (async (message, input) => {
...
AouraQueen['IntroduceCMD']({pattern: 'term ?(.*)', fromMe: true, desc: DATA.TERM_DESC}, (async (message, input) => {
...
AouraQueen['IntroduceCMD']({pattern: 'mediainfo$', fromMe: wk, desc: medinfo}, (async (message, input) => {
    var id = message.jid
...
AouraQueen['IntroduceCMD']({pattern: 'pm ?(.*)', fromMe: true, desc: pmmm, onlyGrpSew: true }, (async (message, input) => {
...
AouraQueen['IntroduceCMD']({pattern: 'pmtts ?(.*)', fromMe: true, desc: psmm, onlyGrpSew: true}, (async (message, input) => {
    if (!message.reply_message) return await message.client.sendMessage(message.jid,NDATA.NEED_REPLY, MessageType.text);
    if (message.reply_message && input[1] == '') return await message.client.sendMessage(message.jid, NDATA.NEED_WORDS, MessageType.text);
    let 
