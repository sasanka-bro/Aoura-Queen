...
let { MessageType, MessageOptions, Mimetype, GroupSettingChange, ChatModification } = require('@yurensasanka/aoura-queen-web');
let fs = require('fs');
let os = require('os');
...
AouraQueen['IntroduceCMD']({on: 'text', fromMe: true, delownsewcmd: false}, (async (message, input) => {
...
AouraQueen['IntroduceCMD']({pattern: 'afk ?(.*)', fromMe: true, delownsewcmd: false, desc: DATA.AFK_DESC}, (async (message, input) => {
    if (!AFK.isAfk) {
