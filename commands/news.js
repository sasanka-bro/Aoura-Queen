...
AouraQueen['IntroduceCMD']({pattern: 'news ?(.*)', fromMe: WorkType, desc: DATA.NEWS_DESC}, async (message, input) => {
...
AouraQueen['IntroduceCMD']({ pattern: 'show ?(.*)', fromMe: WorkType , desc: "Get info related to tv series and shows"}, async (message, input) => {
...
AouraQueen['IntroduceCMD']({ pattern: 'movie ?(.*)', fromMe: WorkType, desc: "Shows movie info." }, (async (message, input) => {
...
let NOT_FOUNDIP = "```Sorry,I could not your IP 😖```"
  ...
  AouraQueen['IntroduceCMD']({pattern: 'ip ?(.*)', desc: 'gives you the detail of your IP' ,fromMe: WorkType}, async (message, input) => {
