...
AouraQueen['IntroduceCMD']({pattern: 'install ?(.*)', fromMe: true, dontAdCommandList: true}, (async (message, match) => {
...
AouraQueen['IntroduceCMD']({pattern: 'mycmd', fromMe: true, dontAdCommandList: true}, (async (message, match) => {
...
AouraQueen['IntroduceCMD']({pattern: 'remove(?: |$)(.*)', fromMe: true, dontAdCommandList: true}, (async (message, match) => {
