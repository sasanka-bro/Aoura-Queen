...
AouraQueen['IntroduceCMD']({pattern: 'unit ?(.*)', fromMe: WorkType, desc: description, usage: 'unit 1 kg mg // unit <number> <unit1> <unit2>'}, (async (message, input) => {
...
AouraQueen['IntroduceCMD']({pattern: 'bitunit ?(.*)', fromMe: WorkType, desc: bit, usage: 'bitunit 1 gb mb // bitunit <number> <unit1> <unit2>'}, (async (message, input) => {
  var splitted_text = input[1].split(' ')
